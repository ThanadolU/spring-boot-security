...
public class ReviewController {
    ...
    public String getReviewPage(@PathVariable UUID restaurantId, Model model) {
        model.addAttribute("restaurant", restaurantService.getOneRestaurant(restaurantId));
    ...
    @PostMapping("/add")
    public String createReview(@Valid ReviewRequest review, BindingResult result, Model model) {
        if (result.hasErrors()) {
